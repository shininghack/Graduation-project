...
<?php } ?>
<style type="text/css">
.cf {margin:10px 0 10px 35px;border: 1px solid gray;border-radius: 20px;background-color: rgba(255,255,255,0.8);}
...
.tbox {padding:0 0 0 18px;position: relative;}
...
<?php else: ?>
    ...
    <?php endif; ?>
    <div class="tbox"><textarea name="text" id="textarea" class="ci" onkeydown="if(event.ctrlKey&&event.keyCode==13){document.getElementById('submit').click();return false};" placeholder="在这里输入你的评论" required ><?php $this->remember('text',false); ?></textarea>
            <img src="<?php $this->options->themeUrl('img/lovely.gif');?>" alt="" class="lovely">
    </div>
